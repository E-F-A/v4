...
[ $RELEASE -eq 8 ] && rpmbuild -ba perl-Math-Int64.spec
[ $? -ne 0 ] && exit 1
[ $RELEASE -eq 8 ] && yum -y install $GITPATH/rpmbuild/RPMS/noarch/perl-Math-Int64-*.rpm
[ $? -ne 0 ] && exit 1
...
[ $? -ne 0 ] && exit 1
[ $RELEASE -eq 7 ] && rpmbuild -ba perl-strictures.spec
[ $? -ne 0 ] && exit 1
[ $RELEASE -eq 7 ] && yum -y install $GITPATH/rpmbuild/RPMS/x86_64/perl-strictures-*.rpm
[ $? -ne 0 ] && exit 1
rpmbuild -ba perl-MooX-StrictConstructor.spec
[ $? -ne 0 ] && exit 1
yum -y install $GITPATH/rpmbuild/RPMS/noarch/perl-MooX-StrictConstructor-*.rpm
[ $? -ne 0 ] && exit 1
[ $RELEASE -eq 8 ] && rpmbuild -ba perl-Data-Dumper-Concise.spec
[ $? -ne 0 ] && exit 1
[ $RELEASE -eq 8 ] && yum -y install $GITPATH/rpmbuild/RPMS/noarch/perl-Data-Dumper-Concise-*.rpm
[ $? -ne 0 ] && exit 1
...
[ $RELEASE -eq 8 ] && rpmbuild -ba perl-Mail-IMAPClient.spec
[ $? -ne 0 ] && exit 1
[ $RELEASE -eq 8 ] && yum -y install $GITPATH/rpmbuild/RPMS/noarch/perl-Mail-IMAPClient-*.rpm
[ $? -ne 0 ] && exit 1
[ $RELEASE -eq 8 ] && rpmbuild -ba perl-Net-DNS.spec
[ $? -ne 0 ] && exit 1
